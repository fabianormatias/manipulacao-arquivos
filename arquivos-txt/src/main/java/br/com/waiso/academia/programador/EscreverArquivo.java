...
/**
 * Programa Java usa o componente Arquivo para escrever (adicionar) conteúdo no
 * arquivo teste.txt O arquivo manipulado por esse programa fica contido no
 * diretório corrente.
 *
 * Objetivos: - escrever conteúdo no arquivo da pasta corrente.
 *
 * Módulo: Lógica de programação | Capítulo: XXX | Página: XXX Author: Eder
 * Magalhães
 */
