...
public class JavaIO {
	...
	/**
	 * Create a text file in the location specified by checking if the place
	 * exists, if not exists it will be created.
	 * 
	 * @param path
	 *            example "c:/tests/io"
	 * @param fileName
	...
	/**
	 * Save the data to disk, allowing you to choose to overwrite the contents
	 * or not.
	 * 
	 * @param fileName
	 * @param content
